        ...
        <div class="box-body">
          ...
          <table id="example2" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              fa.parentesco,
              fa.Id_familiares from familiares fa inner join usuario f on fa.Id_farmaceutico=f.Id inner join usuario p on p.Id=fa.Id_paciente where p.Id='$cid' ") or die(mysqli_error());
              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a class="btn btn-success btn-print" href="" onClick="" role="button">Editar</a>
                    <?php
