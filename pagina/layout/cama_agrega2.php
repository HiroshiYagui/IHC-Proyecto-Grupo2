                ...
                <div class="col-md-8 main_container">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">SOLICITAR CAMA </h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        ...
                        <div class="box-body">
                            <div class="box">
                                <div class="box-body no-padding">
                                    ...
                                    <form class="form-horizontal" name="f1" action="add_cama.php" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 btn-print">
                                                <div class="form-group">
                                                    <label for="date">Hospital</label>

                                                </div><!-- /.form group -->
                                            </div>
                                            <div class="col-md-4 btn-print">
                                                <div class="form-group">
                                                    <select class="form-control select2" name="nom_hospital" required>
                                                        <?php

                                                        $queryc = mysqli_query($con, "select * from cama ") or die(mysqli_error());
                                                        while ($rowc = mysqli_fetch_array($queryc)) {
                                                        ?>
                                                            <option value="<?php echo $rowc['nom_hospital']; ?>"> <?php echo $rowc['nom_hospital']; ?> </option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 btn-print">
                                                <div class="form-group">
                                                    <label for="date">Seleccione una Cama</label>

                                                </div><!-- /.form group -->
                                            </div>
                                            <div class="col-md-4 btn-print">
                                                <div class="form-group">
                                                    <select class="form-control select2" name="id_cama" required>
                                                        ...
                                                        while ($rowc = mysqli_fetch_array($queryc)) {
                                                        ?>
                                                            <option value="<?php echo $rowc['id_cama']; ?>"><?php echo $rowc['cod_cama']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <input name="paciente" id="" type="hidden" required>
