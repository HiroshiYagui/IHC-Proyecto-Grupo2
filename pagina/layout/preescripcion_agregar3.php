                ...
                <div class="col-md-8 main_container">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Prescripciones</h3>
                        </div><!-- /.box-header -->
                        <div class="box-header with-border">
                        ...
                        <div class="box-body">
                            <div class="box">
                                <div class="box-body no-padding">
                                    ...
                                    <form class="form-horizontal" name="f1" action="../preescripcion/terminarVenta.php" method="POST">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <div class="box-body">
                                                        <!-- Date range -->
                                                        <form method="post" action="../preescripcion/agregar_carrito.php" enctype="multipart/form-data" class="form-horizontal">
                                                            <div class="col-md-12 btn-print">
                                                                <div class="form-group">
                                                                    <label for="date" class="col-sm-3 control-label">Medcinas</label>
