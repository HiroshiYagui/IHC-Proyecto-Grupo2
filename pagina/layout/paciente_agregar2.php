...
<div class="container">
    ...
    <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <div class="box-body">
                <form class="form-horizontal" method="post" action="paciente_agregar2.php" enctype='multipart/form-data' ">
                    ...
                    <button type="submit" class="btn btn-primary" id="register" >Guardar cambios</button>
