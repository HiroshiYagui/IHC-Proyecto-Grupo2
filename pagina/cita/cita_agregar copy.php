      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">REGISTRAR NUEVO FAMILIAR</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            ...
            <div class="box-body">
              <div class="box">
                ...
                <div class="box-body no-padding">
                  ...
                  <form class="form-inline" name="f1" action="./cita_add copy.php" method="POST">
                    ...
                    <div class="row">
                      <div class="col-md-3 btn-print">
                        <div class="form-group">
                          <label for="date">Familiar</label>

                        </div><!-- /.form group -->
                      </div>
                      <div class="col-md-4 btn-print">
                        <div class="form-group">
                          <select class="form-control select2" name="id_farmaceutico" required>

                            <?php

                            $queryc = mysqli_query($con, "select * from usuario where tipo='farmaceutico'  ") or die(mysqli_error());
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 btn-print">
                        <div class="form-group">
                          ...
                          <!--<input class="form-control" id="observaciones" name="observaciones"></input>-->
                    ...
                    <br>
                    <button type="submit" class="btn btn-success">Registrar familiar</button>
