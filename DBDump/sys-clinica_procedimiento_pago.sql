...
--
-- Table structure for table `procedimiento_pago`
--
...
--
-- Dumping data for table `procedimiento_pago`
--

LOCK TABLES `procedimiento_pago` WRITE;
/*!40000 ALTER TABLE `procedimiento_pago` DISABLE KEYS */;
INSERT INTO `procedimiento_pago` VALUES (1,'ecografia','realizada on exito',34,'a');
/*!40000 ALTER TABLE `procedimiento_pago` ENABLE KEYS */;
UNLOCK TABLES;
