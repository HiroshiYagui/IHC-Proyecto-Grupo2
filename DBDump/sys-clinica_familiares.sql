...
CREATE TABLE `familiares` (
  `Id_familiares` int(200) NOT NULL AUTO_INCREMENT,
  `Id_farmaceutico` int(200) DEFAULT NULL,
  `parentesco` varchar(45) DEFAULT NULL,
  `Id_paciente` int(200) DEFAULT NULL,
...
INSERT INTO `familiares` VALUES (6,44,'hermano',NULL),(7,45,'coyugue',NULL),(8,47,'hermano',22);
