...
--
-- Table structure for table `detalle_preescripcion`
--
...
--
-- Dumping data for table `detalle_preescripcion`
--

LOCK TABLES `detalle_preescripcion` WRITE;
/*!40000 ALTER TABLE `detalle_preescripcion` DISABLE KEYS */;
INSERT INTO `detalle_preescripcion` VALUES (1,'panadol','50','2 veces al dia',3,'despues de cada comida',2),(2,'paracetamol','100ml','1+0+1',7,'despues del almuerezo',6);
/*!40000 ALTER TABLE `detalle_preescripcion` ENABLE KEYS */;
UNLOCK TABLES;
