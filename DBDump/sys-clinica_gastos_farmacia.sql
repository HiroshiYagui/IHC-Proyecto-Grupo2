...
--
-- Table structure for table `gastos_farmacia`
--
...
--
-- Dumping data for table `gastos_farmacia`
--

LOCK TABLES `gastos_farmacia` WRITE;
/*!40000 ALTER TABLE `gastos_farmacia` DISABLE KEYS */;
INSERT INTO `gastos_farmacia` VALUES (1,3,'solo queda poco','2020-08-08',5);
/*!40000 ALTER TABLE `gastos_farmacia` ENABLE KEYS */;
UNLOCK TABLES;
